<?php
 ...
 {
     header("location:Usuario-directorio.php?cod=$n");
 }
...
<body>
            ...
            <div id="page-inner">
                ...
                <div>
                    ...
                    <form  method="GET" action="BuscarUser.php" >
                        <div class="itemsmy">
                            <input  style="width: 55%;"placeholder="Buscar" name="busqueda" value="<?php echo $Busqueda?>" class="form-control mr-sm-2 alin" type="text">
 ...
 <li class=><a href=''  data-toggle='modal' data-target='#modal2'> <span class='glyphicon glyphicon-plus-sign'></span> Agregar a la organización</a></li>  
     <li class=><a href=''><span class='glyphicon glyphicon-user'></span> Registrarse</a></li>
                                               ...
                                               or u.Telefono_celular Like '%$Busqueda%'
                                                    ...
                                                    while($recorrido = mysqli_fetch_array($Usuarios))   
                                                {
                                                    ...
                                                    $Arreglo='Usuarios[]';
                                                                ...
                                                                echo "<td>" .  "<a href='Usuario-info.php?cod=$n&search=" . $recorrido['id_usuario'] ."'>"   . $recorrido['user'] ."</a>" . "</td>";
                                                                echo "<td>" .  $recorrido['apellidos'] . "</td>";
                                                                  echo "<td>" .  $recorrido['Tipo'] . "</td>";
                                                                echo "<td>" .  $recorrido['id_departamento'] . "</td>";
                                                                echo "<td>" .  $recorrido['id_zona'] . "</td>";
                                                                echo "<td>" .  $recorrido['correo'] . "</td>";
                                                                echo "<td>" .  $recorrido['fecha_creacion'] . "</td>";
                                                                 ?>

                                                            <td><img class="foto"  style="max-width:100px" src="data:image/jpg;base64,<?php echo base64_encode($recorrido['foto']);?>"/></td>
                                                               <?php
                                                                echo "</tr>";
                                                }   
                                            }
                                    ...
                                    <div class="modal-header" style="background: blue;">
                                        <button class="close" data-dismiss="modal">&times;</button>
                                          ...
                                          <form id="add"class="formu"  action="addUsuario.php" method="post">
                                                ...
                                                <input  class=" formu form-control" type="text" name="apellidos" placeholder="Apellidos">
                                                <br>
                                                <label for="contraseña">La contraseña se debe resetear desde la lista de usuarios para seguridad del usuario</label>
                                              <br>
                                              <br>
                                                <label for="correo">Email :</label>
                                                <input   class="formu form-control" type="email" name="correo" placeholder="Correo electronico">
                                                <br>
                                                ...
                                                ?>
                                                <br>
                                                <?php $E=mysqli_query($conexion,"SELECT * FROM rol where idrol !=1");
                                                echo "
                                                <label for='rol'>Rol:</label>
                                                
                                                <select  class='formu form-control'name='rol'>";
                                                if ($E) {
                                                    while ($EST=mysqli_fetch_array($E)) {
                                                ...
                                                <input  class="form-control formu" type="number" name="zona" placeholder="Zona" value="0">
                                                <br>       
  ...
  -->                                             <div class="modal-footer">
    ...
    <div class="container">
                                                        ...
                                                        <button class="close" data-dismiss="modal2">&times;</button>
                                                          ...
                                                          <div class="modal-body">
                                                            ...
                                                            <form class="formu" method="post" action="add_userEquipo.php" >
                                                                <h6>Buscar</h6>  
                                                                <input  class="formu form-control" type="text" size="50%" maxlength="80"  name="titulo" placeholder="Buscar por email, teléfono o nombre" REQUIRED> 
                                                                <button placeholder="Buscar"class="btn btn-light" type="search"><span class="glyphicon glyphicon-search"></span></button>
                                       
                                                                <br>
                                                                <h1>Formulario para dar miembros a un equipo</h1>
                                                                <br>
                                                                <label for="name">Clave del Usuario que desea añadir al equipo :</label>
                                                                <input  class="formu form-control" type="number" name="clave" placeholder="Clave de usuario">
                                                                <br>
                                                                <label for="apellidos">Apellidos :</label>
                                                                <input  class=" formu form-control" type="number" name="clave2" placeholder="Clave del equipo">
                                                                <br>
                  ...
                  -->                                      <div class="modal-footer">
                                                                ...
                                                                <input class="btn btn-success" type="button" value="Restablecer">
                                                                <button class="btn btn-danger" data-dismiss="modal">Cancelar </button>
