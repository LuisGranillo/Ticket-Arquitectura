...
$nombre = "SELECT a.Id_Agente, b.id_usuario , b.nombre From base_de_datos_ticket.Ticket a Inner join sistema_de_competencia.usuario b on a.Id_Agente = b.id_usuario WHERE id_usuario = '$id'";




$respuesta2 = mysqli_query($conexion, $nombre);
while($row2=mysqli_fetch_row($respuesta2))
$q = "SELECT a.*, b.id_usuario , b.nombre From base_de_datos_ticket.Ticket a Inner join sistema_de_competencia.usuario b on a.Remitente = b.nombre WHERE Remitente = '$row2[2]'";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Mis Tickets Solicitados <i class="fa fa-clipboard" aria-hidden="true"></i></h1>
                        <div class="container">
                            ...
                            <table class="table table-striped">
                              ...
                              <?php $respuesta = mysqli_query($conexion, $q);
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn btn-success"><a class="table__item" href="MostrarTicket_solicitados.php?id_T=<?php echo $row[0]; ?>&id=<?php echo $id ?>">Revisar</a></button></td>                                                    
                                            </tr>
