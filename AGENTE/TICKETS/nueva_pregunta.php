...
$categorias = "select tema, id_categ from categoria";
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <form action="insertar_pregunta.php?id=<?php echo $id?>" method="post">
                <h1 class="page-head-line">Agregar Datos <i class="fa fa-clipboard" aria-hidden="true"></i></h1>
                    <h4>Categoria:</h4>
                    <select class="btn btn-success" name="categoria" id="categoria" style="width:165px">
                    <option selected>Seleccionar Categoria</option>
                    <?php $respuesta = mysqli_query($conexion, $categorias);
                    ...
                    <br>                
                    <h4>Pregunta:</h4>                
                    <input style="width:300px; height:30px" type="text" name="pregunta" placeholder="Escribe la pregunta">
                    <br>
                    <br>
                    <h4>Respuesta:</h4>                
                    <textarea name="respuesta"cols="60" rows="5" placeholder="Escribe la respuesta"></textarea>
                    <br>
                    <br>
