                        ...
                        <div class="container">
                          ...
                          <div class="container">           
                            <table class="table table-striped">
                              ...
                              $q = "SELECT COUNT(*)as Total FROM Ticket WHERE( Id_Ticket LIKE '%$busqueda%' OR Remitente LIKE '%$busqueda%' OR Asunto LIKE '%$busqueda%' OR Fecha LIKE '%$busqueda%' OR Fecha_Update LIKE '%$busqueda%') and Id_Equipo = '$id_Equipo'";
                              $respuesta = mysqli_query($conexion, $q);
                              $total = mysqli_fetch_array($respuesta);
                              $resul_total = $total['Total'];
                              $q2 = "SELECT * FROM Ticket WHERE( Id_Ticket LIKE '%$busqueda%' OR Remitente LIKE '%$busqueda%' OR Asunto LIKE '%$busqueda%' OR Fecha LIKE '%$busqueda%' OR Fecha_Update LIKE '%$busqueda%') and Id_Equipo = '$id_Equipo'";
