...
$q = "SELECT a.*, b.id_usuario , b.nombre From base_de_datos_ticket.Ticket a Inner join sistema_de_competencia.usuario b on a.Id_Agente = b.id_usuario WHERE Id_Agente = '$id' and Fecha_Update >= DATE_SUB(CURDATE(), INTERVAL 1 DAY) AND Fecha_Update < CURDATE() AND Id_status ='3'";
                            ...
                            <table class="table table-striped">
                              ...
                              <?php $respuesta = mysqli_query($conexion, $q);
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn btn-success"><a class="table__item" href="MostrarTicket.php?id=<?php echo $row[0]; ?>">Revisar</a></button></td>                                                    
                                            </tr>
