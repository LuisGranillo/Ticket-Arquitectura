...
$q = "SELECT a.Id_Ticket, a.Remitente, a.Id_status, a.Fecha, a.Fecha_Update, a.Asunto, a.Nota_Inter, b.idEquipo FROM base_de_datos_ticket.Ticket a INNER JOIN sistema_de_competencia.equipo b ON a.Id_Equipo = b.idEquipo WHERE idEquipo = '$id_Equipo' order by Fecha asc";
