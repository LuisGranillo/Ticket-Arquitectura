            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 col-sm-4">
                        ...
                        <div class="container">
                            <form action="insertarticket2.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data">
                         
                                <table class="table table-dark">
                                    <thead>
                                        <tr>
                                            <td><h4><b> 2. Detalles del Ticket :</b></h4></td>
                                            <input type="hidden" value="<?php echo $id_equipo ?>" name="Id_Equipo" type="text">
                                            <?php 
                                            include "conexion_2.php";
                                            ...
                                            <?php 
                                            include "conexion_2.php";
                                            $q= "SELECT * from usuario INNER JOIN equipo on usuario.id_usuario = equipo.idUsuario WHERE idEquipo='$id_equipo'";
                                            $respuesta2 = mysqli_query($conexion, $q);
                                            while($row=mysqli_fetch_row($respuesta2)) {?>
