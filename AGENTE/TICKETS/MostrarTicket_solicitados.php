...
$q2 = "SELECT a.*, b.* From base_de_datos_ticket.Ticket a Inner join sistema_de_competencia.usuario b on a.Remitente = b.nombre WHERE Id_Ticket = '$id_T'";
                            ...
                            <div class="text-box">
                                ...
                                <?php $respuesta2 = mysqli_query($conexion, $q);
                                    ...
                                    <?php include "conexion.php";$respuesta2 = mysqli_query($conexion, $q);
                                            while($row2=mysqli_fetch_row($respuesta2)) {?>
                                            <p>Archivo Principal: <a href="MostrarTicket.php?id=<?php echo $row2[0]?>&id_T=<?php echo $id?>"><i class="bi bi-download"></i> Download File</a> </p>
                                            <?php
                                            if(empty($row2[11]))
                                            {
                                                echo "sin archivo";
                    ...
                    <div style=" padding: 15px; margin: 5px;" class="panel panel-back  ">
                        ...
                        <div class="panel panel-default"  >
                            ...
                            <?php include "conexion.php"; $respuesta2 = mysqli_query($conexion, $q2);
                                            while($row2=mysqli_fetch_row($respuesta2)) {?>
                            <form action="Hilo_solicitud.php?id_T=<?php echo $id_T?>&id=<?php echo $id?>" method="post" enctype="multipart/form-data">
