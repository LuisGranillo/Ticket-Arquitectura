...
$q = "SELECT a.*, b.id_usuario , b.nombre From base_de_datos_ticket.Ticket a Inner join sistema_de_competencia.usuario b on a.Id_Agente = b.id_usuario WHERE Id_Agente = '$id' AND YEAR(Fecha_Update) = YEAR(NOW()) AND Id_status ='3'";
