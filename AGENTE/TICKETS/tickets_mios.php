...
$q = "SELECT a.*, b.id_usuario , b.nombre From base_de_datos_ticket.Ticket a Inner join sistema_de_competencia.usuario b on a.Id_Agente = b.id_usuario WHERE id_usuario = '$id'";
...
<body>
    ...
    <!-- /. WRAPPER  -->
    <div id="footer-sec">
        &copy; 2014 YourCompany | Design By : <a href="http://www.utpuebla.edu.mx/" target="_blank">UTP</a>
    </div>
    <!-- /. FOOTER  -->
