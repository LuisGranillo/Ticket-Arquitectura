...
if(empty($busqueda))
{
    header("location: tickets_mios.php?id=$id");
}
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="tickets_abiertos.php?id=<?php echo $id ?>"><i class="bi bi-envelope-open"></i> Abriertos</a></li>
                                                    <li><a href="tickets_resueltos.php?id=<?php echo $id ?>"><i class="bi bi-patch-check"></i> Resueltos</a></li>
                                                    <li><a href="tickets_atrasados.php?id=<?php echo $id ?>"><i class="bi bi-stopwatch"></i> Atrasados</a></li>
                                                </ul>
                                            </div>
                                        </th>
                                        <th>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="cerrados_mios_hoy.php?id=<?php echo $id ?>"><i class="bi bi-calendar-day"></i> Hoy</a></li>
                                                    <li><a href="cerrados_mios_ayer.php?id=<?php echo $id ?>"><i class="bi bi-calendar-date"></i> Ayer</a></li>
                                                    <li><a href="cerrados_mios_mes.php?id=<?php echo $id ?>"><i class="bi bi-calendar-month"></i> Este mes</a></li>
                                                    <li><a href="cerrados_mios_año.php?id=<?php echo $id ?>"><i class="bi bi-calendar-event"></i> Este año</a></li>
                                                </ul>
                                            </div>
                                        </th>
                                        <th>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="tickets_misentradas_recientes.php?id=<?php echo $id ?>"><i class="bi bi-arrow-90deg-down"></i> Recientes </a></li>
                                                    <li><a href="tickets_misentradas_antiguos.php?id=<?php echo $id ?>"><i class="bi bi-arrow-90deg-down"></i> Antiguos</a></li>                                                
                                                </ul>
                                            </div>
                                        </th>   
                                        <th>
                                        ...
                                        <th>
                                            <form action="buscar_ticket.php" method="get" class="form_search">
                        ...
                        <h3>Funciones Del Ticket</h3>                            
                           
                        
                        <h5>Marca la casilla de un ticket para realizar modificaciones en el.</h5>                            
                        ...
                        <div class="container">
                          ...
                          <div class="container">           
                            <table class="table table-striped">
                              ...
                              $q = "SELECT COUNT(*)as Total FROM Ticket WHERE(Id_Ticket LIKE '%$busqueda%' OR Remitente LIKE '%$busqueda%' OR Asunto LIKE '%$busqueda%')";
                              $respuesta = mysqli_query($conexion, $q);
                              $total = mysqli_fetch_array($respuesta);
                              $resul_total = $total['Total'];
                              $q2 = "SELECT * FROM Ticket WHERE( Id_Ticket LIKE '%$busqueda%' OR Remitente LIKE '%$busqueda%' OR Asunto LIKE '%$busqueda%' OR Fecha LIKE '%$busqueda%' OR Fecha_Update LIKE '%$busqueda%') and Id_Agente = '$id'";
                              $respuesta2 = mysqli_query($conexion, $q2);
                              while($row=mysqli_fetch_row($respuesta2)) {?>
                                            <tr>
                                                <td>
                                                    <input type="radio" name="id" value="<?php echo $row[0];?>">
                                                </td> 
                                                ...
                                                <td><button class="btn btn-success"><a class="table__item" href="MostrarTicket.php?id_T=<?php echo $row[0]; ?>&id=<?php echo $id ?>">Revisar</a></button></td>
                                            </tr>
