...
$insertar = "INSERT INTO Ticket(Remitente,Id_Equipo,Id_status,Id_Tema,Asunto,Nota_Inter,Archivo) VALUES ('$Remitente','$Id_Equipo','$Id_status','$Id_Tema','$Asunto','$Nota','$nombre')";
