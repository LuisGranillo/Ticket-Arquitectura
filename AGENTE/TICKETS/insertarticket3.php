...
$insertar = "INSERT INTO Ticket(Remitente,Id_Agente,Id_Departamento,Id_status,Id_Tema,Asunto,Nota_Inter,Archivo) VALUES ('$Remitente','$Id_Agente','$Id_Depa','$Id_status','$Id_Tema','$Asunto','$Nota','$nombre')";
