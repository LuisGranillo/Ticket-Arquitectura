...
$q = "SELECT a.Id_Ticket, a.Remitente, a.Id_status, a.Fecha, a.Fecha_Update, a.Asunto, a.Nota_Inter, b.idEquipo FROM base_de_datos_ticket.Ticket a INNER JOIN sistema_de_competencia.equipo b ON a.Id_Equipo = b.idEquipo WHERE idEquipo = '$id_Equipo' AND Id_status = '4'";
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="tickets_equipo_hoy.php?id_equipo=<?php echo $id_Equipo?>"><i class="bi bi-calendar-day"></i> Hoy</a></li>
                                                    <li><a href="tickets_equipo_ayer.php?id_equipo=<?php echo $id_Equipo?>"><i class="bi bi-calendar-date"></i> Ayer</a></li>
                                                    <li><a href="tickets_equipo_mes.php?id_equipo=<?php echo $id_Equipo?>"><i class="bi bi-calendar-month"></i> Este mes</a></li>
                                                    <li><a href="tickets_equipo_año.php?id_equipo=<?php echo $id_Equipo?>"><i class="bi bi-calendar-event"></i> Este año</a></li>
                                                </ul>
                                            </div>
                                        </th>
                                        <th>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="tickets_equipo_recientes.php?id_equipo=<?php echo $id_Equipo?>"><i class="bi bi-arrow-90deg-down"></i> Recientes </a></li>
                                                    <li><a href="tickets_equipo_antiguos.php?id_equipo=<?php echo $id_Equipo?>"><i class="bi bi-arrow-90deg-down"></i> Antiguos</a></li>                                                
                                                </ul>
                                            </div>
                                        </th>  
                                        <th>
                                            <button style="margin: 5px;" class="btn btn-success"><a href="mis_solicitudes_ticket.php">Tickes Solicitados</a></button>
                                        </th>                                             
                                        <th>
                    ...
                    <form action="actualizar_estado_equipo.php?id_equipo=<?php echo $id_Equipo?>&id=<?php echo $id?>" method="post">
                        <div class="container">
                          ...
                          <div class="container">           
                            <table class="table table-striped">
                              ...
                              <?php include "conexion.php"; $respuesta = mysqli_query($conexion, $q);
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="radio" name="id_s" value="<?php echo $row[0];?>">
                                                </td> 
