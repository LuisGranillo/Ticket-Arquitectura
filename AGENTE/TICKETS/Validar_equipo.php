                    ...
                    <div class="col-md-12 col-sm-4">
                       ...
                       <div class="col-md-12 col-sm-4">
                        <div class="container">
                                ...
                                <br>
                                <h4><b>Visualizacion de Tickets de mis Equipos:</b></h4>
                                <br>
                                    <h4><strong><u>Selecciona un Equipo para mostrar todos los tickets del mismo.</u></strong></h4>
                                <br>
                                <div>
                                    <table class="table table-responsive">
                                        <tbody>
                                            <tr>
                                                <td>
                                                <form action="tickets_equipo_get.php?id=<?php echo $id?>" method="post">
                                                    <br><br>
                                                    <select class="btn btn-success" name="id_equipo" style="width:150px ;height: 70px">
                                                        ...
                                                        $getDep = "SELECT * FROM equipo INNER JOIN trabaja ON trabaja.idEquipo = equipo.idEquipo WHERE id_usuario = '$id'";
