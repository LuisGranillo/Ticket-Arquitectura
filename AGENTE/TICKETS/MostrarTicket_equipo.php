...
$q2 = "SELECT a.Id_Ticket, b.nombre From base_de_datos_ticket.Ticket a Inner join sistema_de_competencia.usuario b on a.Id_Agente = b.id_usuario WHERE Id_Agente = '$id'";

$q = "SELECT a.*, b.*, c.* FROM base_de_datos_ticket.Ticket a INNER JOIN sistema_de_competencia.equipo b ON a.Id_Equipo = b.idEquipo INNER JOIN sistema_de_competencia.usuario c ON a.Remitente = c.nombre WHERE idEquipo = '$id_equipo' AND Id_Ticket = '$id_T'";
                                ...
                                <?php $respuesta2 = mysqli_query($conexion, $q);
                                    ...
                                    <?php include "conexion.php";$respuesta = mysqli_query($conexion, $status);
                                        ...
                                        <tbody>
                                            ...
                                            <td>Remitente: <?php echo $row2[1] ?> <?php echo $row2[21] ?></td>
                                            </tr>
                                            <td>Tel: <a><?php echo $row2[28] ?> </a></td>
                                            <td>Cel: <a><?php echo $row2[29] ?> </a></td>
                                            <tr>
                                            <td>Correo: <a><?php echo $row2[24] ?> </a></td>
                                            <?php } mysqli_free_result($respuesta2)?>
                                            <?php include "conexion.php";$respuesta2 = mysqli_query($conexion, $tema);
                                            while($row2=mysqli_fetch_row($respuesta2)) {?>
                                            ...
                                            <tr>
                                            <td>Nombre de Equipo: <?php echo $row2[13] ?></td>
                                            <td>Descripcion del Equipo: <?php echo $row2[15] ?></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <?php include "conexion.php";$respuesta2 = mysqli_query($conexion, $q);
                                            while($row2=mysqli_fetch_row($respuesta2)) {?>
                                            <p>Archivo Principal: <a href="MostrarTicket_equipo.php?id_T=<?php echo $row2[0]?>&id_equipo=<?php echo $row2[3];?>&id=<?php echo $id;?>"><i class="bi bi-download"></i> Download File</a> </p>
                                            <?php
                                            if(empty($row2[11]))
                                            {
                                                echo "sin archivo";
                ...
                <div class="col-md-12">
                    <div style=" padding: 15px; margin: 5px;" class="panel panel-back  ">
                        ...
                        <div class="panel panel-default"  >
                            ...
                            <?php $respuesta2 = mysqli_query($conexion, $q);
                                            while($row2=mysqli_fetch_row($respuesta2)) {?>
                            <form action="Hilo_equipo.php?id_T=<?php echo $id_T?>&id=<?php echo $id?>" method="post" enctype="multipart/form-data">
                            <?php } mysqli_free_result($respuesta2)?>
                            <div class="panel-footer">
                                ...
                                <?php $respuesta2 = mysqli_query($conexion, $q2);
                                    ...
                                    <input type="hidden" name="nombre" value="<?php echo $row2[1];?>">
                                    ...
                                    <input type="hidden" name="equipo" value="<?php echo $row2[3];?>">
