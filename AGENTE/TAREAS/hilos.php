...
<div class="search-box">
                      ...
                      <img src="../imagenes/b.png" style='border raidus:5px;' width="20" height="20" />
                            ...
                            <?php echo "<a  href='../TAREAS/new.php?codigo=$n'>"?><i class='dropdown-item'></i>Creado más reciente</a>
                              ...
                              <?php echo "<a  href='../TAREAS/hilos.php?codigo=$n'>"?><i class="fa fa-arrow-down fa-lg"></i>Hilos más largos</a>
                    ...
                    <th >Asignado a:</th>
                                         ...
                                         <?php
                                             ...
                                             include("conexion3.php");
                                              $fecha_de_ahora = $mysqli -> query ("SELECT * FROM colas_de_tareas  where id_creador=$n  ORDER BY total DESC");
                                              if ($fecha_de_ahora) {
                                                  while ($fechas = mysqli_fetch_array($fecha_de_ahora)) {
                                                      $n=$_GET['codigo'];
                                                      if ($fechas['id_creador']==$n) {
                                                          $usera=$fechas['id_creador'];
                                                          $tareas_de_usuario_logeado = $mysqli -> query("SELECT*FROM tarea WHERE  idTarea=".$fechas['idTarea']."");
