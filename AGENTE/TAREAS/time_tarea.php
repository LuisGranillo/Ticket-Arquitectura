...
<div class="search-box">
                      ...
                      <img src="../imagenes/b.png" style="border raidus: 5px;"width="20" height="20" />
                            ...
                            <div class="dropdown-menu" >
                              ...
                              <?php echo "<a  href='../TAREAS/time_tarea.php?codigo=$n'>"?><i class="fa fa-arrow-down fa-lg"></i>Fecha de Vencimiento</a>
                    ...
                    <th >Asignado a:</th>
                                         ...
                                         <?php
                                             ...
                                             include("conexion3.php");
                                              ...
                                              $query2 = $mysqli -> query ("SELECT * FROM tarea  where id_usuario='$n'  ORDER BY Vencimiento DESC, hora DESC LIMIT 10 OFFSET 0");
                                              if($query2){ 
