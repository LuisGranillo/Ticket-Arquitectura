...
$titulo=$rows['Titulo'];
  ...
  $query4="SELECT*FROM  actualizaciones WHERE idtarea='$idTarea'";
...
try {
    ...
    $mail->Subject = " Hola agente ( $nombre_usuario2 $apellido_usuario2 ) se ha eliminado de colaborador a: $nombre_usuario3 $apellido_usuario3";//Asunto
    $mail->Body    = "<p style='text-align: justify;'> Hola agente se ha eliminado un colaborador en el numero de tarea :$idTarea , con el titulo : $titulo por el usuario : $nombre_usuario .Favor de estar atento en su vencimiento y verificar dentro de la plataforma gracias.</p></b>
    <br>
    <br>
...
$id_usuario=$_GET['codigo'];
    ...
    echo "<script> 
        alert('Se ha eliminado de forma correcta un colaborador .Colaborador eliminado : $nombre_usuario3 $apellido_usuario3'); 
