...
<head>
    ...
    <title>Directorio de agentes</title>
            ...
            <div id="page-inner">
                ...
                <?php echo "<a href='../PANEL DE CONTROL/panel_control.php?cod=$n'>"?>
                    ...
                    <form method="GET" action="BuscarAgente.php">
                        ...
                        <div class="itemsmy">
                            <input  placeholder="Buscar" name="busqueda" class=" items2 form-control mr-sm-2 alin" type="text">
...
text-overflow: ellipsis;
                        ...
                        <?php 
                         $a= "SELECT u.id_usuario, u.nombre,u.apellidos,u.correo, u.Telefono_casa,u.Telefono_celular , d.nombre as Depa,e.tipo FROM  usuario u INNER JOIN departamento d ON u.id_departamento=d.idDepartamento  INNER JOIN estatus e on  e.idEstatus=u.id_estatus where id_rol= 1";
                        $a2 = mysqli_query($conexion,$a);
                        if($a)
                        {
                        $Agente= mysqli_fetch_array($a2);
                        do
                        {
                                       echo "<tr>";
                                       echo "<td ><input type='checkbox'></td>";
                                       echo "<td>" .  $Agente['id_usuario'] . "</td>";
                                       echo "<td>" .  $Agente['tipo'] . "</td>";
                                       echo "<td>" .  "<a href='/UTP/AGENTE/USUARIOS/Usuario-info.php?cod=$n&search=" . $Agente['id_usuario'] ."'>"   . $Agente['nombre'] ."</a>" . "</td>";
                                       echo "<td>" .  $Agente['apellidos'] . "</td>";
                                         echo "<td>" .  $Agente['correo'] . "</td>";
                                      
                                       echo "<td>" .  $Agente['Telefono_casa'] . "</td>";
                                       echo "<td>" .  $Agente['Telefono_celular'] . "</td>";
                                       echo "<td>" .  $Agente['Depa'] . "</td>";
                                        echo "</tr>";
