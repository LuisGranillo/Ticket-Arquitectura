...
include('cesar.php');
$cifrado_cesar=Cifrar($contra,$contra);
   //Autenticar
   $acceso = "SELECT count(*) as contar FROM usuario WHERE correo='$correo' and contraseña='$cifrado_cesar'";
 ...
 if($filas2['contar']==1) 
 {
  $accesos = "SELECT * FROM usuario WHERE correo='$correo' and contraseña='$contra'";
