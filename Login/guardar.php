         ...
         if($imagen!=""){
           ...
           $imagen='';
            ...
            if ($password==$password2) {
                ...
                $query="INSERT INTO usuario(foto,id_rol,nombre,apellidos,id_departamento,contraseña,correo,id_zona,id_estatus) VALUES ('$imagen', 3, '$nombre','$apellidos',2505,MD5('$password'),'$correo',1,3)";
