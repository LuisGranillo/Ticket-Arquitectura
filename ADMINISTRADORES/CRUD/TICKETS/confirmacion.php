            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4>ATENCION: los <b>Archivos</b> y mensajes relacionados a este <b>Ticket</b> se eliminaran si continuas.</h4>
                        <br>
                        <div class="container">                                                        
                            <button class="btn btn-primary"><a class="table__item" href="Tickets.php?cod=<?php echo $n?>">Regresar</a></button>
