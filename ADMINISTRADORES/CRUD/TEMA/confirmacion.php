            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4>ATENCION: estos son los <b>Tickets</b> relacionados a este <b>Tema</b>, si continuas eliminaras estos registros tambien.</h4>
                        <br>
                        <div class="container">                                                        
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php include ('../conexion_ticket.php');
                                        $id = $_GET["id"];
                                        $q = "SELECT Id_Ticket, Remitente, Id_status, Asunto FROM Ticket WHERE Id_Tema = '$id'";
                        ...
                        <button class="btn btn-primary"><a class="table__item" href="Temas.php?cod=<?php echo $n?>">Regresar</a></button>
