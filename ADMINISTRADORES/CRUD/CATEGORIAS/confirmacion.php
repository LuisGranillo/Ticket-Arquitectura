...
$preguntasE = "SELECT id_pregunta, pregunta, Respuesta FROM pregunta WHERE id_categ = '$id'";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4>ATENCION: estas son las <b>Preguntas</b> relacionadas a esta <b>Categoria</b>, si continuas eliminaras estos registros tambien.</h4>
                        <br>
                        <div class="container">                                                        
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php include "../conexion.php";$respuesta = mysqli_query($conexion, $preguntasE);
                                        while($rowe=mysqli_fetch_row($respuesta)) {?>
                                        <tr>
                                            <td>
                                                ° <?php echo $rowe[0] ?>
                                                <input type="hidden" name="id" value="<?php echo $rowe[0] ?>">    
                                            </td>                                            
                        ...
                        <button class="btn btn-primary"><a class="table__item" href="Categorias.php?cod=<?php echo $n?>">Regresar</a></button>
