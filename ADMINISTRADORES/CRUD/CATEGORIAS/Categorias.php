    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Categorias</h1>
                        <div class="headerseparador">
                            <label for="btn-modal" class="btn btn-success">Insertar Nueva Categoria</label>
                        </div>
                        <div class="container">                                                        
                            <br>
                                ...
                                <form action="insertar.php?cod=<?php echo $n?>" method="post">
                                    <div class="contenedor">
                                        ...
                                        <div class="contenido">                                             
                                            ...
                                            <br>
                                            <h4>Descripcion:</h4>
                                            <input type="text" style="width: 430px" name="descripcion" id="descripcion" placeholder="Escriba la descripcion">
                                            <br>
                                            <div class="header-right">
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr> 
                                        <th><i class="bi bi-stickies-fill"></i> ID CATEGORIA </th>
                                        <th><i class="bi bi-person-square"></i> ID USUARIO </th>
                                        <th><i class="bi bi-folder-symlink"></i> NOMBRE </th>
                                        <th><i class="bi bi-blockquote-right"></i> DESCRIPCION </th>
                                    ...
                                    <?php $respuesta = mysqli_query($conexion, $q);
                                        ...
                                        <form action="actualizar.php?cod=<?php echo $n?>" method="post">
                                            <tr>
                                                ...
                                                <td><input type="text" name="nombre" style="width: 250px" value="<?php echo $row[2] ?>"></td>
                                                <td><input type="text" name="descripcion" style="width: 420px" value="<?php echo $row[3] ?>"></td>
                                                <td>                                                    
