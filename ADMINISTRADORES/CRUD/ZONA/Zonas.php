    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Zonas</h1>
                        <div class="headerseparador">
                            <label for="btn-modal" class="btn btn-success">Insertar Nueva Zona</label>
                        </div>
                        <div class="container">                                                        
                            <br>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr> 
                                        <th><i class="bi bi-geo-alt-fill"></i> ID ZONA </th>
                                        <th><i class="bi bi-pin-map"></i> NOMBRE </th>
                                    ...
                                    <?php $respuesta = mysqli_query($conexion, $q);
                                        ...
                                        <form action="actualizar.php?cod=<?php echo $n?>" method="post">
                                            <tr>
                                                ...
                                                <td><input type="text" name="nombre" style="width: 500px" value="<?php echo $row[1] ?>"></td>
                                                <td>                                                    
