...
<body>
  ...
  <br>
                              ...
                              <table id="tabla" class="table table-dark">
                                  ...
                                  <tbody>
                                  <?php
                          $EQUIPOS = mysqli_query($conexion,"SELECT DISTINCT equipo.idEquipo, equipo.nombre as names ,usuario.nombre,usuario.apellidos,usuario.id_usuario, equipo.Descripcion FROM equipo inner join usuario on usuario.id_usuario=equipo.idUsuario WHERE equipo.idEquipo!=894");
                           if ($EQUIPOS) {
                                        ...
                                        <button class="close" data-dismiss="modal">&times;</button>
                                          ...
                                          <div class="modal-body">
                                            <form id="add"class="formu"  action="../EQUIPOS/addEquipo.php" method="post">
                                                ...
                                                <input REQUIRED  class="formu form-control" type="text" name="a"  placeholder="Nombre">
                                                <br>
