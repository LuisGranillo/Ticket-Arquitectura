...
<label for="">Ingrese la contraseña actual del correo :</label>
<br>
<br>
...
<br>
      ...
      <input name="correo_actualizar"type="text" value=""style="WIDTH: 228px; HEIGHT: 98px"
size=32 name=text1> 
      <br>
<br>
...
<br>
      ...
      <input class=""type="password" name="nueva1">
      <br>
      <label for="">Por favor confirme la contraseña:</label><br>
