...
<body>
    ...
    <div id="wrapper" >
        ...
        <!--Contenido aqui habia un form !-->
                ...
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                        <h1 class="page-head-line"> ESTATUS</h1>
                    ...
                    <form method="POST" action="../ESTATUS/DELETEMUCH.php">
                       <div class='btn-group'>
                                                ...
                                                <!-- dropdown menu links -->
                                                         <li class=><span style='margin-left:22px'class='glyphicon glyphicon-user'></span>  <input class="btn btn-link" style='text-decoration:none;' type="button" data-toggle='modal' data-target='#modal1' value="Nuevo Estatus"> </li>
  ...
  <br>
                              ...
                              <table id="tabla" class="table table-dark">
                                  ...
                                  <tbody>
                                  <?php
                          $ESTATUS = mysqli_query($conexion,"SELECT DISTINCT * FROM estatus ");
                           if ($ESTATUS) {
                               while ($row=mysqli_fetch_array($ESTATUS)) {
                                                    echo "<tr>";
                                                    echo "<td>  <input type='checkbox' name='Usuarios[]' value='" .$row['idEstatus'] . "'></td>";
                                                ?>                      
                                      ...
                                      <?php echo "<td> <button type='button' class='dropbtn' data-toggle='modal' data-target='#pregunta'><img style='max-width:50px;'src='/UTP/ADMINISTRADORES/imagenes/deletes.png'/></button></td>";?>
                                       <?php echo "<td scope='row'> ". $row['idEstatus'] . "</td>";?>
    ...
    <div class="modal fade" id="editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="">
                                            <div class="modal-dialog" role="document">
                                                ...
                                                <div  style="background: #FF334F; color:white; text-align:center"  class="modal-header">
                                                    <h3 class="modal-title" id="exampleModalLabel">Editar Estatus</h3>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="../ESTATUS/udpate.php" method="post">
                            ...
                            <div class="modal" tabindex="-1" id="modal1" >
                                <div class="modal-dialog modal-xlg  modal-dialog-centered">
                                    <div class="modal-content">
                                    <div class="modal-header" style=" text-align:center; background: #FF334F;">
                                        <button class="close" data-dismiss="modal">&times;</button>
                                          <h1 style="color: white;">Agregar un nuevo Estatus</h1>
                                        </div>
                                          <div class="modal-body">
                                            <form id="add"class="formu"  action="../ESTATUS/addEstatus.php" method="post">
                                                  <h1>Formulario para crear un nuevo Estatus </h1>
                                                <br>
  ...
  -->                                      <div class="modal-footer">
                                                  <input class="btn btn-primary" type="submit" value="Crear Estatus">
...
<!-- Button trigger modal -->
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                            <div style="text-align:center; background: #FF334F; color:white;" class="modal-header">
                                                            ...
                                                            <div style="align-items:center; justify-content:center;"class="modal-footer">
                                                                <center>
                                                                <form method="post" action ="../ESTATUS/eliminar.php">
